...
const formSchema = z.object({
  ...
  instructions: z.string().min(200, {
    message: "instructions is required at least 200 chars",
  }),
          ...
          <div className="space-y-2 w-full">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                General information abour your Companion
              </p>
            </div>
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col items-center justify-center space-y-4">
                <FormControl>
                  <Input
                    disabled={isLoading}
                    placeholder="This is supposed to be Image upload section"
                    {...field}
                  />
                </FormControl>
                <FormDescription>Please upload message</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    This is your AI companion will be named
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
